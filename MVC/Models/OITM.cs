...
namespace MVC.Models
{
    ...
    public partial class OITM
    {
        ...
        public string U_SUBFAM { get; set; }
        public string U_APLIC { get; set; }
        public string U_TIPAPLICAC { get; set; }
        public string U_VOLTAJE { get; set; }
        public string U_TAMANO { get; set; }
        public string U_FRAME { get; set; }
        public string U_TAMFRAME { get; set; }
        public string U_ENCAPS { get; set; }
        public string U_MATERIAL { get; set; }
        public string U_VELGIRO { get; set; }
        public string U_POTENCIA { get; set; }
        public string U_CALIBRE { get; set; }
        public string U_Dimension_3 { get; set; }
        public Nullable<decimal> U_MULTIP { get; set; }
        public Nullable<int> U_MINIMO { get; set; }
        public string U_METODO { get; set; }
        public string U_TipoArticulo { get; set; }
        public string U_Partida { get; set; }
        public Nullable<decimal> U_MULTP2 { get; set; }
        public string U_Conf_Volt { get; set; }
        public Nullable<decimal> U_MULTP3 { get; set; }
        public string U_Conf_Cable { get; set; }
        public Nullable<decimal> U_MULTP4 { get; set; }
        public Nullable<decimal> U_MULTP5 { get; set; }
